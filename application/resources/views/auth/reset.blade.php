...
@section('content')
    ...
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            <a href="{{ url('/auth/login') }}" style="padding: 6px" class="btn btn-default btn-block content-group">Log
                In</a>
            ...
            <a href="{{ url('/auth/register') }}" style="padding: 6px" class="btn btn-primary btn-block content-group">Sign
                up</a>
